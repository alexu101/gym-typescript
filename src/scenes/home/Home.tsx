...
function Home({setSelectedPage}: Props) {
    ...
    return (
        <section
            id="home"
            className='flex gap-16 bg-gray-20  md:h-full flex-col justify-between'
        >
        ...
        <motion.div 
            ...
            <div className='z-10 mt-32 md:basis-3/5'>
                ...
                {/* ACTIONS */}
                <motion.div className='mt-8 flex items-center gap-8 md:justify-start'initial='hidden' whileInView="visible" viewport={{once: true, amount: 0.5}} transition={{delay: 0.2, duration: 0.5}} variants={{
                    hidden: {opacity:0, x:-50},
                    visible: {opacity:1, x:0}
                }}>
